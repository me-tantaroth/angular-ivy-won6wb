...
export class UserComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('>> this.usernameParam', this.usernameParam);
  ...
  onSubmit(event: Event, userAffiliate: UserModel) {
    event.stopPropagation();
    event.preventDefault();
    ...
    if (this.formGroup.valid) {
      ...
      value.affiliate = this.usersCollection.doc(userAffiliate.uid).ref;
                      ...
                      userCredential.user
                        ...
                        .then(() => {
                          this.usersCollection
                            ...
                            .then(() => {
                              this.usersCollection
                                .doc(userAffiliate.uid)
                                .collection('notifications')
                                .add({
                                  user: this.usersCollection.doc(
                                    userCredential.user.uid
                                  ).ref,
                                  uid: userCredential.user.uid,
                                  createdAt: new Date(),
                                  message: `${value.firstName} ${value.middleName} se ha unido a tu equipo, sigue su proceso en tu sección de afiliados`,
                                })
                                .then(() => {
                                  this.usersCollection
                                    .doc(userAffiliate.uid)
